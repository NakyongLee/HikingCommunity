...
<%
	request.setCharacterEncoding("UTF-8");
	  ...
	  session.setAttribute("bean", bean);//게시물을 세션에 저장
		...
		String picture = "../fileupload/"+ filename;
...
<table align="center" width="800px" cellspacing="3">
 <tr>
  <td bgcolor="#49a04f" height="25" align="center">글읽기</td>
 </tr>
 <tr>
  <td colspan="2">
  ...
  <td bgcolor="#cff7c3"><%=name%></td>
  <td align="center" bgcolor="#DDDDDD" width="10%"> 등록날짜 </td>
  <td bgcolor="#cff7c3"><%=regdate%></td>
 </tr>
 <tr> 
    <td align="center" bgcolor="#DDDDDD"> 제 목</td>
    <td bgcolor="#cff7c3" colspan="3"><%=subject%></td>
   </tr>
   <tr> 
     <td align="center" bgcolor="#DDDDDD">첨부파일</td>
     <td bgcolor="#cff7c3" colspan="3">
   ...
   <tr> 
    <td colspan="4"><br/><pre style="white-space: pre-wrap;"><%=content%></pre><br/></td>
   </tr>
   <tr>
   	<td><%if (filename != null) { %><img src="<%=picture %>" width="300px"><%} %></td>
   </tr>
   <tr>
