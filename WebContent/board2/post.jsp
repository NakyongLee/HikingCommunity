...
function check() {
    ...
    if (document.postFrm.filename.value == "") {
...
<table width="800px">
	<tr>
		<td bgcolor="49a04f" height="30" align="center">산갤러리 글쓰기</td>
	</tr>
</table>
<br/>
<form name="postFrm" method="post" action="<%=cPath%>/boardPost2" enctype="multipart/form-data">
