...
public class MemberMgr {
	...
	public boolean insertMember(MemberBean bean) {
		...
		try {
			con = pool.getConnection();
			//(id,pwd,name,gender,birthday,email,zipcode,address,hobby,job) (?,?,?,?,?,?,?,?,?,?)
			sql = "insert into tblMember(id,pwd,name,gender,birthday,email,zipcode,address,hobby,job) values (?,?,?,?,?,?,?,?,?,?)";
			pstmt = con.prepareStatement(sql);
	...
	public boolean updateMember(MemberBean bean) {
		...
		try {
			con = pool.getConnection();
			// pwd=?, name=?, gender=?, birthday=? email=?, zipcode=?, address=?, hobby=?, job=?
